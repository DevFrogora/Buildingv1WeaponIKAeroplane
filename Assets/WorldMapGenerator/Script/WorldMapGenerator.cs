    ...
    public void SetUpGridImages()
    {
        switch (OuterGrid)
        {
            case OuterGridEnum.OuterThick:
                outerGridRaw.texture = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/WorldMapGenerator/OuterGrids/8K_Outer_Thick.png", typeof(Texture2D));
                break;

            case OuterGridEnum.OuterThin:
                outerGridRaw.texture = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/WorldMapGenerator/OuterGrids/8K_Outer_Thin.png", typeof(Texture2D));
                break;
        }
        ...
        switch (InnerGrid)
        {
            case InnerGridEnum.Full:
                innerGridRaw.texture = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/WorldMapGenerator/InnerGrids/8K_Inner_Full.png", typeof(Texture2D));
                break;

            case InnerGridEnum.Dotted:
                innerGridRaw.texture = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/WorldMapGenerator/InnerGrids/8K_Inner_Dotted.png", typeof(Texture2D));
                break;

            case InnerGridEnum.CenterDots:
                innerGridRaw.texture = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/WorldMapGenerator/InnerGrids/8K_Inner_CenterDots.png", typeof(Texture2D));
                break;
        }
    }
}